#!/usr/bin/env python3
"""한국 100대 명산 1차 확장(10산) 빌더 — alishan 템플릿(도립/군립공원 당일 산 스타일) 기반.

사실 게이트: 산림청 100대 명산(149산) 목록 포함 여부는 세션 검색으로 확인
(forest.go.kr PDF × 나무위키·월간산 교차). 표고·위치 등 안정적 공용 사실 사용,
버스 노선 등 변동 품목은 「이용 전 확인」 일반화.
"""
...
def ko_courses(o):  # helper building standard 3-course ko structure from compact tuples is skipped; use explicit dicts
    raise NotImplementedError

if __name__ == '__main__':
    from korea100_content import CONTENT, COURSES, MOUNTAINS_LIST
